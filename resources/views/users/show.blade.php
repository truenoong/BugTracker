...
@section('content')
<div class="content">
    @if($users->role_id == 2 or $users->role_id == 4)
    <div class="row">
        <div class="col-md-6">
            @endif
            <div class="card">
            ...
            <div class="card-body">
                <table class="table tableText" id="datatable">
                    ...
                    <tbody id="tbody">
                        ...
                        <tr>
                            <td><a
                                    href="http://bugtracker.test/projects/{{$projectManager->project['project_id']}}">{{$projectManager->project['project_name']}}</a>
                            </td>
                ...
                <div class="card-body">
                    <table class="table tableText" id="datatable">
                        ...
                        <tbody id="tbody">
                            ...
                            <tr>
                                <td><a
                                        href="http://bugtracker.test/projects/{{$projectDeveloper->project['project_id']}}">{{$projectDeveloper->project['project_name']}}</a>
                                </td>
                ...
                <div class="card-body">
                    <table class="table tableText" id="datatable">
                        ...
                        <tbody id="tbody">
                            ...
                            <tr>
                                <td><a
                                        href="http://bugtracker.test/tickets/{{$assignedDeveloper->ticket['ticket_id']}}">{{$assignedDeveloper->ticket['ticket_name']}}</a>
                                </td>
            ...
            <div class="card-body">
                <table class="table tableText" id="datatable">
                    ...
                    <tbody id="tbody">
                        ...
                        <tr>
                            <td><a
                                    href="http://bugtracker.test/tickets/{{$submittedTicket->ticket_id}}">{{$submittedTicket->ticket_name}}</a>
                            </td>
