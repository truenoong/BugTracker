    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <ul class="rightNavbar navbar-nav ml-auto">
            <li id="dashboard" class="nav-item">
                <a href="/" id="login" class="icon-search icon-nav nav-link text-dark font-italic nav-text">Login</a>
            </li>   
            <li id="dashboard" class="nav-item">
                <a href="/register" id="register" class="icon-profile icon-nav nav-link text-dark font-italic nav-text">Register</a>
            </li>
        </ul>
    </div>
</nav>
...
<nav class="navbar horizontal-navbar navbar-expand-lg navbar-light">
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <ul class="navbar-nav mr-auto">
            ...
            <a id="profile" class="icon-profile icon-nav nav-link text-dark font-italic">
